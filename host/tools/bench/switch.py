"""Switch the gate drivers, now. Nothing else.
    ...
    python tools/bench/switch.py                       # 50 %, 60 s, all three legs
    python tools/bench/switch.py -d 0.25 -s 120        # one duty, two minutes
    python tools/bench/switch.py --sweep 5,95 -p 10    # triangle, 10 s per sweep
