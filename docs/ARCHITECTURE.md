...
Twenty-six suites, 2589 checks, counted in `host/tests/.counts.json`
by `counts.py`:
...
| test_sensorless.py | 118 | the design arithmetic, the commissioning and the motion verbs against the stand-in |
