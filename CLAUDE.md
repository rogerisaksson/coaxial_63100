...
Twenty-four suites, 2177 checks, sized from `host/tests/.counts.json` and so
measured rather than remembered: `test_structure.py` (479),
...
* **Any 5 % step is a tier.** Suites join by seconds per check - measured:
  ...
  764 of this tree's 2177 checks are in those nine files.
