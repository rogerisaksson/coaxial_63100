...
Twenty-six suites, 2680 checks, sized from `host/tests/.counts.json` and so
...
(62, the 3D engine stage by stage against an analytic oracle -
...
(97, every view and the front page drawn twice, plus the rotor
...
* **Any 5 % step is a tier.** Suites join by seconds per check - measured:
  ...
  766 of this tree's 2680 checks are in those nine files.
