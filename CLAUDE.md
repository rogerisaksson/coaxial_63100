...
Twenty-seven suites, 3084 checks, sized from `host/tests/.counts.json` and so
measured rather than remembered: `test_structure.py` (665),
...
* **Any 5 % step is a tier.** Suites join by seconds per check - measured:
  ...
  773 of this tree's 3084 checks are in those nine files.
