...
// host as they come. Renode joins a terminal to a UART only, hence two faces.
...
namespace Antmicro.Renode.Peripherals.UART
{
    ...
    public class RS485_AdapterBus : IUART, IGPIOReceiver
    {
        ...
        {
            BaudRate = baudRate;
            timer = new LimitTimer(machine.ClockSource, baudRate, this, "character", limit: BitsPerCharacter,
