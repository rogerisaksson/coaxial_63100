...
Twenty-eight suites, 3242 checks, sized from `host/tests/.counts.json` and so
measured rather than remembered: `test_structure.py` (715),
...
* **Any 5 % step is a tier.** Suites join by seconds per check - measured:
  ...
  778 of this tree's 3242 checks are in those nine files.
