...
Twenty-eight suites, 3173 checks, counted in `host/tests/.counts.json`
by `counts.py`:
...
| test_render.py | 92 | the 3D engine stage by stage against an analytic oracle, the scanline halftone and the drawn rim |
