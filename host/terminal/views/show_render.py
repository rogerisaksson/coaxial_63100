...
The HUD shows the pose, the mesh budget and what the frame cost.
    ...
    python terminal/views/show_render.py
    python terminal/views/show_render.py --model board
"""
import argparse
import math
import os
...
from terminal.screen import (Keys, WHEEL_STEP, curtain, footer, paced, rate_of,  # noqa: E402
                             stage, TO_MENU)
from terminal.stage import Corner                                   # noqa: E402
