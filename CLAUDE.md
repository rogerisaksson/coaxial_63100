...
Twenty-four suites, 2181 checks, sized from `host/tests/.counts.json` and so
measured rather than remembered: `test_structure.py` (483),
...
* **Any 5 % step is a tier.** Suites join by seconds per check - measured:
  ...
  764 of this tree's 2181 checks are in those nine files.
