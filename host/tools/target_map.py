...
One line apiece: the cheapest way into the target.
    ...
    python tools/target_map.py --layers   # which layer includes which, counted
    python tools/target_map.py --deps comms       # each file's tree headers
    python tools/target_map.py --ops      # command -> handler -> public calls
"""
import argparse
import glob
import io
