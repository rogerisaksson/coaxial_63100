...
in. The board cannot design anything; it chooses between designs.
    ...
    cd host
    python tools/bench/daq_adapt.py               # watch it climb and fall
    python tools/bench/daq_adapt.py --starve 6    # a longer bottle
...
def main(argv=None):
    ...
    # THE BOARD'S LADDER, SO THE BOARD'S HANDLE.
    try:
        device.open()
