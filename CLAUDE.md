...
Twenty-six suites, 2648 checks, sized from `host/tests/.counts.json` and so
...
(65, every view and the front page drawn twice, plus the rotor
...
* **Any 5 % step is a tier.** Suites join by seconds per check - measured:
  ...
  766 of this tree's 2648 checks are in those nine files.
