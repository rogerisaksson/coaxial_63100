...
Twenty-six suites, 2793 checks, sized from `host/tests/.counts.json` and so
...
(151, every view and the front page drawn twice, plus the rotor
...
* **Any 5 % step is a tier.** Suites join by seconds per check - measured:
  ...
  773 of this tree's 2793 checks are in those nine files.
