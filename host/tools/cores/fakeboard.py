...
(board/fake/fake_board.c), the ports are a byte ring and a clock the exchange steps
(board/fake/fake_uart.c). One fake board a process.
"""
import ctypes
import glob
import os
...
#: portable cores under it; board/fake for the board.
