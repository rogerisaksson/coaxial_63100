...
docs/BOOT.md has the sequence.
    ...
    python tools/target/flash_nodes.py --store DIR --simulated --bus LL
    python tools/target/flash_nodes.py --store DIR --port COM4 --bus LL
    python tools/target/flash_nodes.py --store DIR --place <uid> LL 2 coaxial_63100
